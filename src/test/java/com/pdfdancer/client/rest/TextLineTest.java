...
public class TextLineTest extends BaseTest {
    ...
    public void findLinesByPosition() {
        ...
        assertEquals("TEXTLINE_000005", first.getInternalId());
        ...
        assertEquals("TEXTLINE_000678", last.getInternalId());
    ...
    public void findLinesByText() {
        ...
        assertEquals("TEXTLINE_000006", line.getInternalId());
    ...
    public void findSingularTextLineByMatching() {
        ...
        assertEquals("TEXTLINE_000006", line.get().getInternalId());
