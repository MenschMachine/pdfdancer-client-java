...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = com.tfc.pdf.pdfdancer.api.common.model.path.Line.class, name = "line"),
        @JsonSubTypes.Type(value = com.tfc.pdf.pdfdancer.api.common.model.path.Line.class, name = "LINE"),
        @JsonSubTypes.Type(value = com.tfc.pdf.pdfdancer.api.common.model.path.Bezier.class, name = "bezier"),
        @JsonSubTypes.Type(value = com.tfc.pdf.pdfdancer.api.common.model.path.Bezier.class, name = "BEZIER")
})
